...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERTENANT_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERTENANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERTENANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERTENANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERTENANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERTENANT actions', async () => {
      const expectedActions = [
        {
